  ...
  return (
    <ThemeProvider attribute='class'>
      <div className="grid grid-cols-12 gap-6 px-5 my-10 lg:px-48 sm:px-20 md:px-32">
        <div className='col-span-12 p-4 text-base text-center bg-white lg:col-span-3 dark:text-white rounded-2xl dark:bg-dark-500 shadow-custom-light dark:shadow-custom-dark'>
          <Sidebar />
        </div>
